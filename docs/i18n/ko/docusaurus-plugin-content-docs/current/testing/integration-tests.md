...
여러 Hook을 결합한 전체 흐름에 대한 통합 테스트 작성법입니다.

## Wallet Creation -> Balance Check Flow
...
describe('Full Wallet Flow', () => {
  it('should complete entire wallet lifecycle', async () => {
    ...
    // Note: requestFaucet()은 브라우저에서 faucet 웹사이트를 엽니다
...
- [E2E Tests](/docs/testing/e2e-tests) - Detox를 사용한 E2E 테스트
